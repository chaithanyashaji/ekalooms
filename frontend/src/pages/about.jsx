...
const About = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white border-2 border-[#65000B] rounded-lg shadow-xl p-8 md:p-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          <div className="md:w-1/3">
            <div className="rounded-lg overflow-hidden border-2 border-[#65000B] shadow-lg">
              <img
          ...
          <div className="md:w-2/3 space-y-5 text-gray-600">
            <div className="pl-2 sm:pl-5">
              <p className="Outfit leading-relaxed pb-4 italic text-[#65000B]">Welcome to ekalooms,</p>
              ...
              <br />
              <p className="text-md text-left italic text-[#65000B]  pt-4 font-serif ">
                Happy Shopping! 
              </p>
              <p className="prata-regular text-md text-[#65000B] flex items-center">
