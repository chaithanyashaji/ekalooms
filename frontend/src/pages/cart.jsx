...
const Cart = () => {
  ...
  if (!productData) {
    return (
      <div
        key={index}
        className="py-4 border-t border-b text-[#9D4A54] flex justify-between items-center"
      >
        <div className="flex items-start gap-6">
          ...
          />
          <div>
            <p className="text-xs sm:text-lg font-medium text-gray-400">
        ...
        <div className="flex gap-4 items-center">
          <input
            disabled
            className="border rounded-md max-w-10 max-h-10 text-center sm:max-w-20 px-2 py-1 text-gray-400 bg-gray-100"
            type="number"
            value={item.quantity}
          />
          <img
